...
#
# Examples:
# CHAIN_ID="local-1" HOME_DIR="~/.stakermania" BLOCK_TIME="1000ms" CLEAN=true sh scripts/test_node.sh
# CHAIN_ID="local-2" HOME_DIR="~/.stakermania" CLEAN=true RPC=36657 REST=2317 PROFF=6061 P2P=36656 GRPC=8090 GRPC_WEB=8091 ROSETTA=8081 BLOCK_TIME="500ms" sh scripts/test_node.sh
...
export HOME_DIR=$(eval echo "${HOME_DIR:-"~/.stakermania"}")
export BINARY=${BINARY:-stmd}
export DENOM=${DENOM:-stm}
...
from_scratch () {
  ...
  # stm1efd63aw40lxf3n4mhf7dzhjkr453axur2a6rt9
  ...
  # stm1hj5fveer5cjtn4wd6wstzugjfdxzl0xpkff8zv
